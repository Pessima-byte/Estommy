                    ...
                    >
                        <View style={styles.header}>
                            <View>
                                ...
                                <View style={styles.subtitleRow}>
                                    ...
                                    <Text style={styles.creditRef}>TX REF: #{credit.id?.slice(0, 8).toUpperCase()}</Text>
                                </View>
                            </View>
                        ...
                        <View style={styles.content}>
                            ...
                            <View style={styles.inputSection}>
                                ...
                                <TouchableOpacity
                                    style={[styles.inputWrapper, styles.imageBtn, (!!imageUri || !!credit.image) && styles.imageBtnActive]}
                                    onPress={pickImage}
                                >
                                    <View style={styles.btnContent}>
                                        <Camera size={20} color={(imageUri || credit.image) ? '#FFF' : '#C5A059'} />
                                        <Text style={[styles.btnText, (imageUri || credit.image) && styles.btnTextActive]}>
                                            {imageUri ? 'NEW PHOTO STAGED' : (credit.image ? 'CHANGE CURRENT PHOTO' : 'ADD SUPPORTING PHOTO')}
                                        </Text>
                                    </View>
