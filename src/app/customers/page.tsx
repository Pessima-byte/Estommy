                                ...
                                <div className="flex items-start justify-between mb-8 relative z-10">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            className="w-10 h-10 rounded-xl bg-white/[0.03] border border-white/5 hover:border-[#25D366]/40 hover:bg-[#25D366]/10 text-white/30 hover:text-[#25D366] flex items-center justify-center transition-all duration-300 disabled:opacity-30 disabled:cursor-not-allowed"
